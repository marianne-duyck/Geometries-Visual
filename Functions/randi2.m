function y = randi2(x,varargin)
%RANDI2 Pseudorandom integers from a uniform discrete distribution.
...
if (nargin==1)
    y = x(1)-1+randi(x(2)-x(1)+1);
else
    y = x(1)-1+randi(x(2)-x(1)+1,[varargin{1},varargin{2}]);
end